...
const translations: Record<SupportedLanguage, TranslationSet> = {
  en: {
    ...
    cloudBackup: {
      ...
      contactsSyncTitle: 'Contacts sync',
      noContactsInBackup: 'This backup has no contacts to sync.',
      contactsSyncFailed: 'Could not sync contacts. Check your password and connection.',
  ...
  bg: {
    ...
    cloudBackup: {
      ...
      contactsSyncTitle: 'Синхронизиране на контакти',
      noContactsInBackup: 'Това копие няма контакти за синхронизиране.',
      contactsSyncFailed: 'Контактите не можаха да бъдат синхронизирани. Проверете паролата и връзката.',
