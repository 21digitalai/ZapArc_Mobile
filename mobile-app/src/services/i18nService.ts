  ...
  en: {
    ...
    home: {
      ...
      securityBanner: {
        ...
        lightningAddressSubtitle: 'Get a simple name@zaparc.app address so others can pay you instantly.',
        enable: 'Enable',
        backUp: 'Back up',
        claim: 'Claim',
        notNow: 'Not now',
  ...
  bg: {
    ...
    home: {
      ...
      securityBanner: {
        ...
        lightningAddressSubtitle: 'Получете лесен адрес име@zaparc.app, за да могат другите да ви плащат веднага.',
        enable: 'Включи',
        backUp: 'Архивирай',
        claim: 'Вземи',
        notNow: 'Не сега',
