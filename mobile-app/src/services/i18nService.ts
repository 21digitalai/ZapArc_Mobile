...
const translations: Record<SupportedLanguage, TranslationSet> = {
  en: {
    ...
    send: {
      ...
      selectedAmount: 'Selected: {{amount}} {{currency}}',
      recipient: 'Recipient:',
      total: 'Total:',
      ...
      paymentDescriptionPlaceholder: 'Add a comment',
      recipientCommentUnsupported: 'Recipient comments are available only for Lightning Address and LNURL-pay payments.',
    ...
    settings: {
      ...
      invoiceExpiryDescription: 'Choose how long newly created invoices remain payable.',
      invoiceExpiryInvalid: 'Enter a duration from 60 minutes to 7 days.',
      custom: 'Custom',
      customMinutes: 'Custom duration in minutes',
      minute: 'minute',
      minutes: 'minutes',
      hour: 'hour',
      hours: 'hours',
    ...
    cloudBackup: {
      ...
      contactsSyncTitle: 'Restore Contacts',
      noContactsInBackup: 'This backup has no contacts to restore.',
      contactsSyncFailed: 'Could not restore contacts. Check your password and connection.',
      contactsSyncWrongPassword: 'Incorrect backup password. Please try again.',
      contactsSyncCorrupt: 'The contacts section is corrupt and could not be read safely.',
      ...
      manageBackupDescription: 'Choose how to manage this encrypted cloud copy.',
      replaceBackup: 'Replace Backup',
      replaceBackupDescription: "Replace the cloud copy with this wallet's current data and selected contacts.",
      restoreContacts: 'Restore Contacts',
      restoreContactsDescription: 'Merge missing cloud contacts into this phone. Local contacts stay untouched.',
      changeBackupPassword: 'Change Backup Password',
      changeBackupPasswordDescription: 'Verify the current password, then encrypt this backup with a new one.',
      verifyCurrentBackupPassword: 'Verify current backup password',
      replaceBackupPasswordRecovery: 'Forgot the current password? Delete this backup first, then create a new backup. It cannot be overwritten without verification.',
      currentBackupPassword: 'Current backup password',
      newBackupPassword: 'New backup password',
      changePassword: 'Change password',
      deleteBackupDescription: 'Permanently remove this cloud copy. This cannot be undone.',
      backedUp: 'Backed up',
      notBackedUp: 'Not backed up',
      lastBackedUp: 'Last backed up {{date}}',
      walletDataIncluded: 'Wallet data included',
  ...
  bg: {
    ...
    send: {
      ...
      selectedAmount: 'Избрано: {{amount}} {{currency}}',
      recipient: 'Получател:',
      total: 'Общо:',
      ...
      paymentDescriptionPlaceholder: 'Добавете коментар',
      recipientCommentUnsupported: 'Коментарите до получателя са налични само за Lightning Address и LNURL-pay плащания.',
    ...
    settings: {
      ...
      invoiceExpiry: 'Валидност на фактурата',
      invoiceExpiryDescription: 'Изберете колко дълго могат да се плащат новосъздадените фактури.',
      invoiceExpiryInvalid: 'Въведете продължителност от 60 минути до 7 дни.',
      custom: 'По избор',
      customMinutes: 'Продължителност в минути',
      minute: 'минута',
      minutes: 'минути',
      hour: 'час',
      hours: 'часа',
    ...
    cloudBackup: {
      ...
      contactsSyncTitle: 'Възстанови контакти',
      noContactsInBackup: 'Това копие няма контакти за възстановяване.',
      contactsSyncFailed: 'Контактите не можаха да бъдат възстановени. Проверете паролата и връзката.',
      contactsSyncWrongPassword: 'Неправилна парола за копието. Опитайте отново.',
      contactsSyncCorrupt: 'Секцията с контакти е повредена и не можа да бъде прочетена безопасно.',
      ...
      manageBackup: 'Управление на копието',
      manageBackupDescription: 'Изберете как да управлявате това криптирано облачно копие.',
      replaceBackup: 'Замени копието',
      replaceBackupDescription: 'Заменете облачното копие с текущите данни на портфейла и избраните контакти.',
      restoreContacts: 'Възстанови контакти',
      restoreContactsDescription: 'Добавете липсващите облачни контакти на този телефон. Местните контакти остават непроменени.',
      changeBackupPassword: 'Смени паролата за копието',
      changeBackupPasswordDescription: 'Потвърдете текущата парола, след което криптирайте това копие с нова.',
      verifyCurrentBackupPassword: 'Потвърдете текущата парола за копието',
      replaceBackupPasswordRecovery: 'Забравихте текущата парола? Първо изтрийте това копие, след което създайте ново. Не може да бъде заменено без потвърждение.',
      currentBackupPassword: 'Текуща парола за копието',
      newBackupPassword: 'Нова парола за копието',
      changePassword: 'Смени паролата',
      deleteBackupDescription: 'Премахнете това облачно копие завинаги. Действието не може да бъде отменено.',
      backedUp: 'Архивирано',
      notBackedUp: 'Няма копие',
      lastBackedUp: 'Последно копие {{date}}',
      walletDataIncluded: 'Включени данни на портфейла',
      backUpNow: 'Създай копие сега',
