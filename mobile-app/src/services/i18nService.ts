...
const translations: Record<SupportedLanguage, TranslationSet> = {
  en: {
    ...
    send: {
      ...
      saveContactBody: 'Add this Lightning address to your contacts so you can pay it again in one tap.',
      saveContactConfirm: 'Save as contact',
      saveContactDismiss: 'Not now',
      ...
      invoiceExpiredMessage: 'This Lightning invoice has expired. Ask the sender for a new invoice and scan it again.',
      invoiceUnreadableTitle: 'Invoice cannot be read',
      invoiceUnreadableMessage: 'This Lightning invoice may be expired or created in a format this version cannot read. Ask the sender for a new invoice and try again.',
      ...
      manage: 'Manage',
      asset: {
        onchainDisabled: 'USDB transfers stay on Spark.',
        swapToBtcLink: 'Swap to BTC →',
        bolt11NotForUsdb: 'Bolt11 invoices are for Bitcoin. Switch to the BTC tab or paste a Spark invoice.',
    ...
    home: {
      ...
      securityBanner: {
        ...
        cloudBackupTitle: 'Back up your wallet',
        cloudBackupSubtitle: 'Save an encrypted backup to Google Drive so you never lose access to your funds.',
        lightningAddressTitle: 'Claim your Lightning Address',
        lightningAddressSubtitle: 'Get a simple name@breez.tips address so others can pay you instantly.',
        enable: 'Enable',
        backUp: 'Back up',
        claim: 'Claim',
        notNow: 'Not now',
    ...
    swap: {
      ...
      max: 'Max',
      maxBtcLabel: 'Max (keep 500 sats for fees)',
      ...
      slippage: 'Slippage',
      advanced: 'Advanced',
      slippagePreset01: '0.1%',
      slippagePreset05: '0.5%',
      slippagePreset10: '1%',
      slippageCustomLabel: 'Custom (bps)',
      error: {
        insufficientBalance: 'Insufficient balance',
        belowMin: 'Minimum swap: {{amount}} {{unit}}',
        aboveMax: 'Maximum swap: {{amount}} {{unit}}',
        limitsUnavailable: 'Limits unavailable - swap temporarily disabled',
        limitsRetry: 'Retry',
        offline: 'No connection - connect to the internet to swap',
        connectionLost: 'Connection lost - swap may fail',
        timeoutBody: 'Swap timed out. Check your connection and try again.',
        title: 'Swap failed',
        retry: 'Retry',
      ...
      backgrounded: {
        toast: 'Swap in progress - please wait',
      },
      review: {
        title: 'Review Swap',
        direction: 'Direction',
    ...
    deposit: {
      ...
      minWarning: 'Sending a smaller amount on-chain may make it impossible to claim — the Bitcoin network fee to claim a deposit can exceed a tiny amount, leaving nothing. For small amounts, use Lightning instead.',
      minWarningWithFee: 'Claiming an on-chain deposit currently costs about {{fee}} sats in Bitcoin network fees. A deposit at or below this can\'t be claimed economically. For small amounts, use Lightning instead.',
      ...
      statusConfirmingProgress: 'Confirming · {{count}}/{{required}} confirmations',
      statusClaiming: 'Claiming',
      statusRetrying: 'Retrying',
      statusTooSmall: 'Too small to claim',
    ...
    settings: {
      ...
      defaultPaymentAmounts: 'Default Payment Amounts',
      ...
      defaultAmountsWhenPaying: 'Default amounts shown when paying others',
      defaultAmountsWhenCreatingRequests: 'Default amounts shown when creating payment requests',
      small: 'Small',
      medium: 'Medium',
      large: 'Large',
      ...
      paymentAmountsError: 'Payment amounts: {{error}}',
    ...
    onboarding: {
      ...
      restoreFromCloud: 'Restore from Cloud Backup',
      addSubWallet: 'Add Sub-Wallet',
    ...
    addressBook: {
      ...
      addNewHint: 'Save a name and address for quick sending',
      name: 'Name',
      nameOptional: 'Name (optional)',
      lightningAddress: 'Lightning Address',
      sparkAddressOptional: 'Spark Address (optional)',
      notes: 'Notes',
    ...
    cloudBackup: {
      ...
      includeContactsHint: 'Back up your address book (encrypted with this password)',
      contactsIncluded: 'Contacts included',
      partialRestoreTitle: 'Wallet restored, contacts skipped',
      partialRestoreBody: 'The wallet backup was restored, but its contacts section could not be read safely.',
      mergeContactsTitle: 'Restore contacts?',
      mergeContactsBody: 'This backup contains {{count}} saved contacts. Add the ones you don’t already have?',
      mergeContactsSkip: 'Skip',
      mergeContactsConfirm: 'Merge',
      mergeContactsResult: 'Added {{added}}, skipped {{skipped}} already saved.',
  ...
  bg: {
    ...
    wallet: {
      ...
      failureReason: 'Причина за неуспеха',
      ...
      tapToCopy: 'Докоснете, за да копирате',
    ...
    payments: {
      ...
      payment: 'Плащане',
      paymentSentSuccessfully: 'Плащането е изпратено успешно!',
    },
    ...
    send: {
      ...
      saveContactTitle: 'Запази като контакт?',
      saveContactBody: 'Добави този Lightning адрес в контактите, за да платиш отново с едно докосване.',
      saveContactConfirm: 'Запази като контакт',
      saveContactDismiss: 'Не сега',
      ...
      invoiceExpiredTitle: 'Фактурата е изтекла',
      invoiceExpiredMessage: 'Тази Lightning фактура е изтекла. Поискайте нова фактура от получателя и я сканирайте отново.',
      invoiceUnreadableTitle: 'Фактурата не може да бъде прочетена',
      invoiceUnreadableMessage: 'Тази Lightning фактура може да е изтекла или да е във формат, който тази версия не поддържа. Поискайте нова фактура и опитайте отново.',
      ...
      manage: 'Управление',
      asset: {
        onchainDisabled: 'USDB преводите остават в Spark.',
        swapToBtcLink: 'Суапни към BTC →',
        bolt11NotForUsdb: 'Bolt11 фактурите са за Bitcoin. Превключете към BTC таба или поставете Spark фактура.',
        switchToBtc: 'Превключи към BTC',
      },
    },
    ...
    home: {
      ...
      securityBanner: {
        ...
        cloudBackupTitle: 'Архивирайте портфейла си',
        cloudBackupSubtitle: 'Запазете криптиран архив в Google Drive, за да не загубите достъп до средствата си.',
        lightningAddressTitle: 'Вземете своя Lightning адрес',
        lightningAddressSubtitle: 'Получете лесен адрес име@breez.tips, за да могат другите да ви плащат веднага.',
        enable: 'Включи',
        backUp: 'Архивирай',
        claim: 'Вземи',
        notNow: 'Не сега',
    ...
    swap: {
      ...
      flipDirection: 'Обърни посоката на суапа',
      max: 'Макс',
      maxBtcLabel: 'Макс (запазва 500 сатс за такси)',
      ...
      slippagePreset05: '0.5%',
      slippagePreset10: '1%',
      slippageCustomLabel: 'Персонален (bps)',
      error: {
        insufficientBalance: 'Недостатъчен баланс',
        belowMin: 'Минимален суап: {{amount}} {{unit}}',
        aboveMax: 'Максимален суап: {{amount}} {{unit}}',
        limitsUnavailable: 'Лимитите не са налични - суапът е временно изключен',
        limitsRetry: 'Опитай отново',
        offline: 'Няма връзка - свържете се с интернет за суап',
        connectionLost: 'Връзката е прекъсната - суапът може да се провали',
        timeoutBody: 'Суапът изтече. Проверете връзката и опитайте отново.',
      ...
      backgrounded: {
        toast: 'Суапът е в ход - моля изчакайте',
      },
      review: {
        title: 'Преглед на суапа',
        direction: 'Посока',
        youPay: 'Плащате',
        youReceive: 'Получавате',
        rate: 'Курс',
    ...
    deposit: {
      ...
      minWarning: 'Изпращането на по-малка сума on-chain може да направи усвояването невъзможно — таксата на Bitcoin мрежата за прибиране на депозит може да надвиши малка сума и да не остане нищо. За малки суми използвайте Lightning.',
      minWarningWithFee: 'Прибирането на on-chain депозит в момента струва около {{fee}} сатс такси по Bitcoin мрежата. Депозит на или под тази стойност не може да бъде усвоен икономически. За малки суми използвайте Lightning.',
      onchainNote: 'Средствата са налични след мрежови потвърждения.',
      onchainDeposit: 'On-chain депозит',
      recentReceives: 'Скорошни получавания',
      statusConfirming: 'Потвърждава се',
      statusConfirmingProgress: 'Потвърждава се · {{count}}/{{required}} потвърждения',
      statusClaiming: 'Усвояване',
      statusRetrying: 'Нов опит',
      statusTooSmall: 'Твърде малък за усвояване',
      statusDetails: 'Подробности за статуса',
    ...
    settings: {
      ...
      defaultPaymentAmounts: 'Стандартни суми за плащане',
      ...
      paymentAmounts: 'Суми за плащане',
      defaultAmountsWhenPaying: 'Стандартни суми, показвани при плащане',
      defaultAmountsWhenCreatingRequests: 'Стандартни суми, показвани при създаване на заявки за плащане',
      small: 'Малка',
      medium: 'Средна',
      large: 'Голяма',
      ...
      paymentAmountsError: 'Суми за плащане: {{error}}',
    ...
    onboarding: {
      ...
      restoreFromCloud: 'Възстанови от облачен бекъп',
      addSubWallet: 'Добави под-портфейл',
    ...
    addressBook: {
      ...
      addNew: 'Добави нов контакт',
      addNewHint: 'Запази име и адрес за бързо изпращане',
      name: 'Име',
      nameOptional: 'Име (незадължително)',
      lightningAddress: 'Lightning адрес',
      sparkAddressOptional: 'Spark адрес (незадължително)',
      notes: 'Бележки',
    ...
    cloudBackup: {
      ...
      includeContacts: 'Включи контактите',
      includeContactsHint: 'Архивирай адресната книга (криптирана с тази парола)',
      contactsIncluded: 'Включени контакти',
      partialRestoreTitle: 'Портфейлът е възстановен, контактите са пропуснати',
      partialRestoreBody: 'Копието на портфейла е възстановено, но секцията с контакти не можа да бъде прочетена безопасно.',
      mergeContactsTitle: 'Възстанови контактите?',
      mergeContactsBody: 'Това копие съдържа {{count}} запазени контакта. Да добавя ли тези, които още нямаш?',
      mergeContactsSkip: 'Пропусни',
      mergeContactsConfirm: 'Обедини',
      mergeContactsResult: 'Добавени {{added}}, пропуснати {{skipped}} вече запазени.',
